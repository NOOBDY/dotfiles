" vimrc
let g:indent_markers = 1 "0 by default, this option shows indent markers when folders are open
...
let g:special_files = { 'README.md': 1, 'Makefile': 1, 'MAKEFILE': 1 } " List of filenames that gets highlighted with NvimTreeSpecialFile
let g:show_icons = {
    \ 'git': 1,
    \ 'folders': 0,
    \ 'files': 0,
